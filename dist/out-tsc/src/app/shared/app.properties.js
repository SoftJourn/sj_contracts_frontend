export var AppProperties = (function () {
    ...
    AppProperties.API_COINS_ENDPOINT = 'https://sjcoins-testing.softjourn.if.ua/coins/v1';
    ...
    AppProperties.ERIS_COMPILER = 'https://sjcoins-testing.softjourn.if.ua/coins/v1/contracts/compile';
    AppProperties.AUTH_API = AppProperties.AUTH_SERVER + '/v1';
