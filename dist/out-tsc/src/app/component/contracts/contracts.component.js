...
export var ContractsComponent = (function () {
    ...
    ContractsComponent.prototype.openContract = function (event, index) {
        if (!event.defaultPrevented) {
            this.router.navigate(['/contracts/' + index]);
        }
    };
    ContractsComponent.prototype.changeActivation = function (event, contractId) {
        var _this = this;
        event.preventDefault();
        this.contractService.changeActive(contractId).subscribe(function (response) {
            _this.contractService.getContracts().subscribe(function (contracts) {
                _this.contracts = contracts;
            });
        });
    };
